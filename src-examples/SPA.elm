...
import Examples.Cards
import Examples.Clock
import Examples.Geolocation
...
type alias Flags =
    ...
    , innerWidth : Int
    , locationHref : String
    , startingState : Maybe Examples.Todos.Model
...
type alias Model =
    ...
    , isSideMenuOpen : Bool
    , isSmallScreen : Bool
    , pageCardsModel : Examples.Cards.Model
    , pageClockModel : Examples.Clock.Model
    , pageGeolocationModel : Examples.Geolocation.Model
    , pageTodoModel : Examples.Todos.Model
    , route : Route.Route
...
init flags =
    ...
    ( { counter = 0
      ...
      , pageCardsModel = Examples.Cards.initModel
      , pageClockModel = clockModel
      , pageGeolocationModel = geolocationModel
      , pageTodoModel = Examples.Todos.initModel { startingState = flags.startingState }
...
subscriptions model =
    Sub.batch
        ...
        , case model.route of
            Route.Clock ->
                Sub.map MsgPageClock (Examples.Clock.subscriptions model.pageClockModel)
...
type Msg
    ...
    | MsgGotNewWidth Int
    | MsgOnPressHamburger
    | MsgPageCards Examples.Cards.Msg
    | MsgPageClock Examples.Clock.Msg
    | MsgPageGeolocation Examples.Geolocation.Msg
    | MsgPageTodos Examples.Todos.Msg
    | MsgPushUrl String
...
update msg model =
    case msg of
        ...
        MsgPageCards subMsg ->
            let
                ( subModel, cmd ) =
                    Examples.Cards.update subMsg model.pageCardsModel
            in
        ...
        MsgPageClock subMsg ->
            let
                ( subModel, cmd ) =
                    Examples.Clock.update subMsg model.pageClockModel
            in
        ...
        MsgPageGeolocation subMsg ->
            let
                ( subModel, cmd ) =
                    Examples.Geolocation.update subMsg model.pageGeolocationModel
            in
        ...
        MsgPageTodos subMsg ->
            let
                ( subModel, cmd ) =
                    Examples.Todos.update subMsg model.pageTodoModel
            in
